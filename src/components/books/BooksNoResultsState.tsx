...
export interface BooksNoResultsStateProps {
  onClearFilters: () => void;
  className?: string;
}
 ...
 */
export function BooksNoResultsState({ onClearFilters, className }: BooksNoResultsStateProps) {
  return (
    <div className={cn("flex flex-col items-center justify-center gap-6 p-12 text-center", className)}>
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground max-w-md">
          Nie znaleziono książek pasujących do kryteriów wyszukiwania. Spróbuj zmienić filtry lub wyczyść je, aby
          zobaczyć wszystkie książki.
        </p>
      </div>
