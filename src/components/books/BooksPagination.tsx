...
/**
 * Pagination controls for books list.
 * Shows previous/next buttons and page information (Page X of Y).
 */
export function BooksPagination({ currentPage, totalPages, onPageChange, className }: BooksPaginationProps) {
