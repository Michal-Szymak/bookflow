...
const olResults = await openLibraryService.searchAuthors(validatedQuery.q, validatedQuery.limit);
...
const cachedAuthors = await authorsService.findByOpenLibraryIds(olResults.map((r) => r.openlibrary_id));
